...
t2mean_gmean=mean(dat1$treat2)-gmean,sq2=(dat3$t2mean-gmean),
t3mean_gmean=mean(dat1$treat3-gmean),sq3=(dat3$t3mean_gmean),
...
MSB=SS_btwn/3 #mean sum of squares between groups divide by the # of groups)-1
